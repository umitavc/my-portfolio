...
const Data = () => {
    return (
        <div className=' home__data'>
            <h1 className="home__title">Umit Avci
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
            ...
            <h3 className='home__subtitle'>Sowftware Developer</h3>
            <p className='home__description'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda voluptatem distinctio quis, ducimus doloribus repudiandae quidem aliquam exercitationem alias? Laudantium, non! Quisquam in porro accusantium illum impedit non explicabo aperiam.</p>
